...
function getTerraform(version) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        if (!toolPath) {
            ...
            toolPath = yield acquireTerraform(version);
...
function acquireTerraform(version) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        //
        return yield tc.cacheDir(extPath, 'terraform', version);
    });
}
function queryLatestMatch(versionSpec) {
    return __awaiter(this, void 0, void 0, function* () {
        let versions = [];
        let rest = new restm.RestClient('setup-terraform');
        let release = (yield rest.get('https://releases.hashicorp.com/terraform/index.json')).result;
...
function getDownloadUrl(version) {
    return util.format(`https://releases.hashicorp.com/terraform/%s/terraform_%s_%s_%s.zip`, version, version, osPlat, osArch);
}
//
